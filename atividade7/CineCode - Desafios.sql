...
-- ALUNO: ____Guilherme______________________________________________________________
-- DATA: ___/___/______
--
-- INSTRUÇÕES:
...
select * from clientes where regiao= 'Sudeste' and sexo= 'feminino';

-- 9. Precisamos listar os filmes de 'Mistério e Suspense' OU 'Ficção e Fantasia'.


select * from filmes where genero= 'Mistério e Suspense'or'Ficção e Fantasia';
-- -----------------------------------------------------------------------------
...
update filmes  set preco_aluguel =
1.50 where genero='Comédia' and ano_lancamento=2001;
...
-- Qual é o erro? ______Faltou o =____________________________________________________
-- Correção:
SELECT titulo, genero, ano_lancamento FROM filmes WHERE ano_lancamento =2005 ORDER BY titulo;
...
-- Qual é o erro? ________era para ter colocado regiao__________________________________________________
-- Correção:
...
-- Qual é o erro? _________________________null sem ''_ e is null sem =________________________________
-- Correção:
...
-- Qual é o erro? __________atores escrito errado no final________________________________________________
-- Correção:
...
-- Correção
UPDATE filmes SET genero = 'Fantasia' where titulo='Harry Potter';
-- -----------------------------------------------------------------------------
...
select nota from alugueis where nota is not null;